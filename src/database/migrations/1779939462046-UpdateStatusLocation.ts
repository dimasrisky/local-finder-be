...
export class UpdateStatusLocation1779939462046 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."location_status_enum" AS ENUM('processing', 'done', 'failed')`);
        await queryRunner.query(`ALTER TABLE "location" ADD "status" "public"."location_status_enum"`);
    }
