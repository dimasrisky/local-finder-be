...
export class InisiasiLocation1777020813466 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "location_item" ADD "locationId" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "location_item" ADD CONSTRAINT "FK_312fe72f8d91cd39115c2f84a41" FOREIGN KEY ("locationId") REFERENCES "location"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "location_item" DROP CONSTRAINT "FK_312fe72f8d91cd39115c2f84a41"`,
    );
    await queryRunner.query(
      `ALTER TABLE "location_item" DROP COLUMN "locationId"`,
    );
